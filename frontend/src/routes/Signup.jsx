  ...
  return (
    <div className='w-full h-full flex flex-col items-center'>
      ...
      <div className='w-1/3 py-10 flex flex-col items-center'>
        ...
        <div className='flex justify-center items-center w-full py-5 border-gray-400 border-b-2'>
          <button className='bg-app-green font-bold p-3 px-10 rounded-full'>SIGN UP</button>
        </div>
